...
become worse --- the patients with higher RTS scores. In Albaaj's study
respiratory rate \>29, systolic blood pressure 50-75 mmHg and 76-89
mmHg, and Glasgow Coma Scale 9-12 were significantly related to
increased odds of OFI in the unadjusted analysis, but not in the
...
the trauma, but who are relatively stable in this group of patients.
This creates a sense of false security, leading to increased time until
necessary emergency procedures are performed.

#Se om det finns källa som pekar på vilken grupp av patienter som bör få
mer fokus på IVA?
...
#Leta efter artikel om att längre vårdtis på IVA ger sämre utfall och
vad orsakerna är
...
#Lägga in artikel om hur IVA patienter behandlas baserat på kön eller
ålder + artikel om hur ASA-poängen eller pat allvarlighetsgrad påverkar
bedömningen av OFI
...
increasing medical resources outside working hours.

#Lägga in artikel som pekar på om duty påverkar handläggning eller inte
...
#Artikel om hur ISS bedöms kunna användas i samanhang av trauma
...
Hospital in Solna. This leads to a risk of misplacement where some
patients with OFI were not selected by for the review based on the audit
filters although there was an OFI later on in the hospitalization
process.

#Lägga in källa för audit filters - Kelvins artikel (mejlar Jocke)

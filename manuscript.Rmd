...
OFI was identified in 143 of 1449 patients. Revised Trauma Score, ≤ 7
days in the ICU and death within 30 days after hospitalization were
significantly associated with OFI in the unadjusted analysis, and
Revised Trauma Score and ≤ 7 days in the ICU were significantly
associated with OFI in the adjusted analysis.
...
For the RTS-value the GCS, SBP and RR values were converted to a
RTS-code between 0 and 4.
...
instead. If the patient was intubated A complete case analysis was
conducted after handling missing values. We present sample
...
respiratory rate with more weight towards GCS as mentioned in the
introduction. An explanation for the increased odds of OFI in patients
with increased RTS could be that the patients with low RTS values - with
low GCS, RR and SBP also are the once that are in a bad state upon
arrival - upon which emergency procedures e.g. intubation have been
carried out rapidly due to the patients being very ill from the
beginning. The patients who are being missed and where certain
procedures take longer time before being performed are the patients who
seem stable upon arrival, but who later become worse --- the patients
with higher RTS scores. In Albaaj's study respiratory rate \>29,
systolic blood pressure 50-75 mmHg and 76-89 mmHg, and Glasgow Coma
Scale 9-12 were significantly related to increased odds of OFI in the
unadjusted analysis, but not in the adjusted analysis [@12]. All of
these variables equal medium RTS values.

The variable ≤ 7 days in the ICU was significantly associated with
decreasing odds of OFI in both the adjusted and unadjusted analyses. An
explanation would be that less days spent in the ICU compared to more
days spent in the ICU indicates that patients have been in a better
state and needed less time of recovery before leaving the hospital.
Furthermore, a longer stay leads to more space for mistakes being made.
...
process. #Lägga in källa för audit filters - Kelvins artikel?
...
the limited size of the Swedish database.
...
the hospital are the group where improved trauma care should be focused
on. The logistical regression also showed that ≤ 7 days in the ICU was
associated with decreased odds of OFI indicating that patients who are
at the hospital less days in the ICU compared to more days in the ICU
are less prone to opportunities for improvement.
